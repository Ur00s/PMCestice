...
#define DEVICE_EUI "0011223344556677"  // Replace with your Device EUI
#define APP_EUI "AABBCCDDEEFF0011"     // Replace with your Application EUI
#define APP_KEY "112233445566778899AABBCCDDEEFF00" // Replace with your App Key
#define enableLcd GPIO_PIN_15
...
/*
void setup() {
    // Initialize HAL, peripherals, and system clock
    HAL_Init();
    SystemClock_Config();
    ...
    lorawan_set_device_eui(DEVICE_EUI);
...
void loop() {
    ...
    // Join LoRaWAN network if not joined already
